---
slug: quinton-histoire-plasma-marin
title: "René Quinton et le “plasma marin” : une intuition d’époque, une preuve qui manque"
description: "De l’océan primitif aux ampoules modernes : histoire, rhétorique et limites méthodologiques du “plasma de Quinton”."
tags: [histoire, evidence-based, compléments-alimentaires, quinton, eau-de-mer]
date: 2026-02-11
image: /img/blog/quinton/quinton-portrait.png
---

import Admonition from '@theme/Admonition';

import Pub1914 from '@site/static/img/blog/quinton/pub-1914.png';
import QuintonPortrait from '@site/static/img/blog/quinton/quinton-portrait.png';
import Dispensaire from '@site/static/img/blog/quinton/dispensaire-epoque.png';

# René Quinton et le “plasma marin” : une intuition d’époque, une preuve qui manque
...
<figure>
  <img src={QuintonPortrait} alt="Portrait de René Quinton" />
  <figcaption>René Quinton. Une figure typique d’une période où la physiologie se cherche encore des applications thérapeutiques directes.</figcaption>
</figure>
...
<figure>
  <img src={Dispensaire} alt="Bâtiment de dispensaire du début du XXe siècle, illustration d’ambiance" />
  <figcaption>Un dispensaire du début du XXᵉ siècle : un décor plausible pour comprendre comment ces pratiques ont pu se diffuser et s’institutionnaliser.</figcaption>
</figure>
...
<figure>
  <img src={Pub1914} alt="Publicité de 1914 pour une cure marine promettant des 'énergies vitales'" />
  <figcaption>Publicité (1914) : promesses globales, vocabulaire de “vitalité” et de “forces” — une rhétorique qui traverse le temps plus facilement que les preuves.</figcaption>
</figure>
