...
synopsis: "Version chocolat gourmand de la boisson fonctionnelle Bonjour Drink. Mélange d’extraits de champignons adaptogènes (Lion’s Mane, Cordyceps, Chaga) enrichi en cacao, vanille et cannelle, présenté comme alternative sans caféine pour une énergie douce et un moment réconfortant."
ean: [3770033452042]
hide_title: true
---
...
Extrait de graine de Cacaoyer (Theobroma cacao), Extrait de corps fructifère de Lion’s Mane (Hericium erinaceus), Extrait de corps fructifère de Chaga (Inonotus obliquus), Extrait de mycélium de Cordyceps (Cordyceps sinensis), Poudre de gousse de Vanille bourbon (Vanilla planifolia), Poudre d’écorce de Cannelle (Cinnamomum).
...
|-----------------|---------------|:--:|-------------|
| Clarté mentale ([Lion’s Mane](/docs/principes/lion's_mane)) | Cognition, mémoire | ⚫ F | Essais exploratoires négatifs ; aucune confirmation clinique robuste. |
| Énergie / endurance ([Cordyceps](/docs/principes/cordyceps)) | Performance physique | 🟠 D | Petites études hétérogènes, résultats non confirmés. |
| Immunité / antioxydants ([Chaga](/docs/principes/chaga)) | Défenses naturelles | ☠️ | Aucun bénéfice clinique + risque rénal (oxalates). |
| Énergie / concentration | Vigilance | ⚫ F | Absence d'effet démontré cliniquement. |
...
- **Actifs :** extraits concentrés de champignons.  
