...
categories: ["Santé intime", "Probiotiques"]
synopsis: "Complément alimentaire à base de lactobacilles et bifidobactéries (6 souches), avec FOS et vitamine B2, positionné sur le confort intime et l’équilibre de la flore vaginale."
ean: 3664524000532
hide_title: true
---
...
|-----------|----------|--------------------|
| [**Lactobacillus acidophilus DSM 21717 (LA02)**](/docs/principes/lactobacillus-acidophilus) | 10 milliards UFC | Une étude clinique humaine identifiée dans la candidose vulvovaginale récidivante, mais **par voie vaginale et en association** avec une autre souche. Données **non transposables** à un probiotique oral multi-souches. |
| [**Lactobacillus crispatus DSM 33822**](/docs/principes/lactobacillus-crispatus) | 7 milliards UFC | *L. crispatus* est associé à un microbiote vaginal protecteur, mais **aucune étude clinique publiée n’est clairement attribuable à la souche DSM 33822**. Les essais positifs concernent d’autres souches (ex. CTV-05), **par voie vaginale**. |
| [**Lactobacillus gasseri LMG 26661**](/docs/principes/lactobacillus-gasseri) | 7 milliards UFC | Absence de preuves cliniques robustes publiées pour cette souche dans la santé vaginale. |
| [**Lactobacillus rhamnosus GG ATCC 53103**](/docs/principes/lacticaseibacillus_rhamnosus) | 4,4 milliards UFC | Souche très bien documentée chez l’humain pour la santé digestive et la sécurité. **Aucune preuve clinique directe pour la flore vaginale**. |
| [**Bifidobacterium bifidum DSM 22892**](/docs/principes/bifidobacterium-bifidum) | 2 milliards UFC | Aucune étude clinique humaine publiée retrouvée pour cette souche dans l’indication revendiquée. |
| [**Lactobacillus fermentum AGAL NM02/31704**](/docs/principes/lactobacillus-fermentum) | 1,6 milliard UFC | Absence de données cliniques humaines publiées identifiables pour cette souche précise. |
...
| [**Vitamine B2 (riboflavine)**](/docs/principes/vitamine_b2) | 0,44 mg (30 % AR) | Allégation EFSA valide : maintien de muqueuses normales. Pertinence surtout **en cas de carence**, sans démonstration d’effet thérapeutique sur une dysbiose vaginale. |
...
>**Point clé :** 
>En santé vaginale, **un probiotique oral n’est pas efficace “par principe”**.  
