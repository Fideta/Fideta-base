...
synopsis: "Complément alimentaire associant 8 souches probiotiques pour un apport total de 80 milliards d’UFC/jour, positionné comme cure courte de soutien du microbiote après perturbation, sans preuve clinique spécifique."
ean: [3401560288322]
hide_title: true
---
...
|-----------|----------|--------------------|
| [**Bifidobacterium lactis LA304**](/docs/principes/bifidobacterium-lactis) | Non précisée | Étudiée uniquement dans une autre formulation (Lactibiane Iki®) associée à d’autres souches, chez des patients atteints de diverticulite aiguë non compliquée. Étude ouverte, sans placebo, niveau de preuve faible à modéré. **Non extrapolable à Lactichoc.** |
| [**Lactobacillus acidophilus LA201**](/docs/principes/lactobacillus-acidophilus) | Non précisée | Même situation que LA304 : données cliniques indirectes, formulation et indication différentes. **Aucune preuve pour ce produit.** |
| [**Lactobacillus gasseri LA806**](/docs/principes/lactobacillus-gasseri) | Non précisée | Données essentiellement précliniques et observationnelles. **Absence d’essai clinique contrôlé démontrant un bénéfice clinique.** |
| [**Bifidobacterium bifidum LA803**](/docs/principes/bifidobacterium-bifidum) | Non précisée | **Aucune étude clinique publiée identifiable** pour cette souche spécifique. |
| [**Bifidobacterium breve LA805**](/docs/principes/bifidobacterium-breve) | Non précisée | Pas de données cliniques disponibles pour cette souche. Les résultats observés avec d’autres souches de l’espèce ne sont pas extrapolables. |
| [**Lacticaseibacillus rhamnosus LA801 (GG)**](/docs/principes/lacticaseibacillus_rhamnosus) | Non précisée | Souche équivalente à *L. rhamnosus* GG (ATCC 53103), largement documentée (diarrhée associée aux antibiotiques). **Mais l’absence de dose par souche empêche toute conclusion clinique pour Lactichoc.** |
| [**Lactobacillus acidophilus LA807**](/docs/principes/lactobacillus-acidophilus) | Non précisée | Aucune donnée clinique publiée spécifique. Présence redondante sans justification clinique démontrée. |
| [**Bifidobacterium animalis subsp. lactis**](/docs/principes/bifidobacterium-lactis) | Non précisée | Espèce largement étudiée selon les souches (BB-12, HN019…), **sans correspondance démontrée ici**. |
...
1. Eur Rev Med Pharmacol Sci. 2019;23(20):9126-9133.  
2. Cochrane Database Syst Rev. Probiotics for preventing antibiotic-associated diarrhoea.  
3. Cochrane Database Syst Rev. Probiotics for prevention of *Clostridioides difficile*-associated diarrhea.  
4. ANSES. *Probiotiques et prébiotiques : état des connaissances.*  
5. EFSA NDA Panel. *Scientific opinions on health claims related to probiotics.*  
...
<sub><em>Dernière mise à jour : 11 janvier 2026</em></sub>
