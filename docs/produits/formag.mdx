...
hide_title: true
---
<div style={{display:'flex',alignItems:'center',justifyContent:'space-between',gap:'1rem',margin:'0.5rem 0 1.25rem'}}> <div style={{minWidth:0}}> <h1 style={{margin:0}}>Formag</h1> <p style={{margin:0}}><strong>Marque / Laboratoire :</strong> PiLeJe<br/><strong>Catégorie :</strong> Minéral – Magnésium</p> </div> <img src="/img/produits/formag.png" alt="Formag - PiLeJe" style={{objectFit:'contain', maxWidth:'32%', minWidth:'160px', height:'auto'}} /> </div>
---
