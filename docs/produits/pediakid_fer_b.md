---
title: "PEDIAKID Fer + Vitamines B"
image: /img/produits/pediakid_fer_b.jpg
categories: ["Énergie", "Fatigue", "Enfant"]
synopsis: "Complément alimentaire à base de fer, vitamines B, spiruline, fibres et extraits végétaux. Pertinence limitée : couvre uniquement les VNR, sous-dosé pour traiter l’anémie ferriprive, aucun bénéfice prouvé chez l’enfant sain."
ean: 3700225600289
hide_title: true
---
<div className="product-hero">
  <div className="product-hero__titlewrap">
    <h1 style={{margin:0}}>PEDIAKID Fer + Vitamines B</h1>
    <p style={{margin:0}}>
      <strong>Marque / Laboratoire :</strong> INELDEA (France)<br/>
      <strong>Catégorie :</strong> Mixte (minéral + vitamines + extraits végétaux + fibres)
    </p>
  </div>

  <div className="product-hero__packshot">
    <img src="/img/produits/pediakid_fer_b.jpg" alt="PEDIAKID Fer + Vitamines B - INELDEA" loading="eager" />
  </div>
</div>
---
...
| ------------------------------------------------------------- | ---------------- | ------------------ |
| [**Fer (pyrophosphate ferrique, microencapsulé)**](/docs/principes/fer)              | 14 mg            | Couvre les VNR mais insuffisant pour traiter une anémie ferriprive (nécessite 3–6 mg/kg/j). Forme FePP moins biodisponible que FeSO₄ ; avantage microencapsulation non prouvé. |
| [**Vitamine B1**](/docs/principes/vitamine_b1)                | 1,1 mg (100 % AR)| Couvre les besoins ; aucun effet antifatigue démontré hors déficit. |
| [**Vitamine B2**](/docs/principes/vitamine_b2)                | 1,4 mg (100 % AR)| Allégation UE validée « métabolisme du fer » mais sans preuve de bénéfice clinique supplémentaire. |
