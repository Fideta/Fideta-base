---
title: PreserVision 3
image: /img/produits/preservision-3.jpg
categories: ["Produits"]
synopsis: "Formule oculaire associant DHA, lutéine, zéaxanthine et antioxydants. Inspiration partielle des travaux AREDS2 mais non-équivalence aux protocoles validés en DMLA et absence d’essai clinique sur le produit fini."
ean : [3401246028716 , 3401598267825 , 3614790000248]
hide_title: true
---
...
<ProduitHero
  ...
  image={"/img/produits/preservision-3.jpg"}
  imageAlt={"PreserVision 3"}
  path={"/docs/produits/preservision-3"}
/>
...
PreserVision 3 repose sur une inspiration des travaux AREDS2 concernant la dégénérescence maculaire liée à l’âge (DMLA).
...
- Le [DHA](/docs/principes/omega-3) (≥ 250 mg/j) contribue au maintien d’une vision normale.
- Le [Zinc](/docs/principes/zinc) contribue au maintien d’une fonction visuelle normale.
...
Ainsi, en l’absence d’essai clinique sur le produit et sans équivalence stricte aux protocoles validés, PreserVision 3 ne peut pas être considéré comme une stratégie thérapeutique fondée sur des preuves.
...
| [Oméga-3](/docs/principes/omega-3) totaux | 600 mg | Apport nutritionnel cohérent mais non validé comme bénéfice spécifique DMLA. |
| [DHA](/docs/principes/omega-3) | 360 mg | Seuil réglementaire atteint pour l’allégation « vision normale ». |
| [Vitamine C](/docs/principes/vitamine_c) | 180 mg | Antioxydant ; dose nettement inférieure au protocole AREDS (500 mg). |
...
| [Vitamine D3](/docs/principes/vitamine_d) | 5 µg | Intérêt principalement en cas d’insuffisance ; hors protocole AREDS2. |
| [Lutéine](/docs/principes/luteine) | 10 mg | Dose alignée AREDS2 ; données favorables en DMLA intermédiaire. |
| [Zéaxanthine](/docs/principes/zeaxanthine) | 2 mg | Dose alignée AREDS2. |
...
| **Vitamine D3** | **5 µg** | **0 µg** | **Hors AREDS2**, effet surtout nutritionnel |
...
2. Cochrane Database Syst Rev. Antioxidant supplements for preventing AMD.  
3. Cochrane Database Syst Rev. Antioxidants for slowing progression of AMD.  
4. EFSA Scientific Opinion on Tolerable Upper Intake Level for Zinc.  
5. EFSA Scientific Opinion on DHA and maintenance of normal vision.

---

<sub><em>Dernière mise à jour : 27 février 2026</em></sub>