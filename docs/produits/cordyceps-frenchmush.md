---
title: "Cordyceps"
image: /img/produits/cordyceps-frenchmush.jpg
categories: ["Énergie", "Performance", "Champignons"]
synopsis: "Complément alimentaire à base d’extrait de mycélium de Cordyceps biologique, présenté comme source naturelle d’énergie et de vitalité."
ean: 3770021157638
hide_title: true
---
...
<div className="product-hero">
  <div className="product-hero__titlewrap">
    ...
    <p style={{margin:0}}>
      ...
      <strong>Catégorie :</strong> Champignon médicinal (extrait de mycélium)
    </p>
  </div>

  <div className="product-hero__packshot">
    <img src="/img/produits/cordyceps-frenchmush.jpg" alt="Cordyceps - French Mush" loading="eager" />
  </div>
</div>
...
1. Le **taux de cordycépine (0,6 %)** est typique de [*Cordyceps militaris*](/docs/principes/cordyceps-militaris), alors que [*Ophiocordyceps sinensis*](/docs/principes/cordyceps) en contient moins de 0,01 %.  
   ➤ Ce profil chimique oriente clairement vers [*C. militaris*](/docs/principes/cordyceps-militaris).
2. Le **prix de vente (~30 € pour 60 gélules)** est incompatible avec l’usage de [*C. sinensis*](/docs/principes/cordyceps) authentique, dont la matière première dépasse 20 000 €/kg.  
   ➤ L’espèce employée est vraisemblablement [*C. militaris*](/docs/principes/cordyceps-militaris) cultivé industriellement.
3. Le **rapport d’analyse (COA – juin 2024)** mentionne la norme chinoise **NY/T 1676-2008**, méthode colorimétrique utilisée pour les extraits de champignons cultivés en Chine.  
   ➤ Cela suggère une **origine chinoise de la matière première**.
4. Le **catalogue européen des Novel Foods (2025)** classe *C. militaris* comme **non autorisé**, tandis que *O. sinensis* (mycélium) est « non novel ».  
   ➤ Le mélange d’appellations entretient une **confusion réglementaire**.

Ces indices convergent vers l’utilisation de [***Cordyceps militaris***](/docs/principes/cordyceps-militaris) sous étiquette « [*Cordyceps sinensis*](/docs/principes/cordyceps) ».  
...
1. Ontawong A et al. *Sci Rep.* 2024 – Immunité *C. militaris*.  
2. Dewi L et al. *Food & Function* 2024 – Récupération musculaire post-exercice.  
3. Yu X et al. *Phytother Res.* 2019 – BPCO : biais méthodologiques majeurs.  
4. McCleary BV & Draga A. *J AOAC Int.* 2016 – Aucune méthode AOAC validée pour β-glucanes fongiques.  
5. EU Novel Food Catalogue (2025) – *C. sinensis* non novel / *C. militaris* novel non autorisé.  
6. NY/T 1676-2008 – Norme chinoise de dosage des polysaccharides totaux.
