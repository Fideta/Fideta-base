...
categories: ["Plantes"]
synopsis: "Plante médicinale polyvalente (racine et feuille) utilisée traditionnellement comme diurétique ou pour les troubles prostatiques. Les preuves cliniques modernes restent limitées et hétérogènes. Aucune preuve d’effet hormonal spécifique ou d’efficacité sur le SOPK."
synonyms: ["Urtica dioica", "Urtica urens", "Grande ortie", "Stinging nettle"]
...
| Cible hormonale / métabolique | Résultat observé | Niveau de preuve | Commentaire |
|-------------------------------|------------------|:----------------:|-------------|
| **Androgènes (testostérone, DHEA)** | Aucune baisse observée | ⚫ **F** | L’unique étude humaine (2025, 60 femmes) montre absence d’effet sur les taux hormonaux ou le hirsutisme |
| **Régularité du cycle** | Amélioration légère possible | 🟠 **D** | Cycles un peu plus réguliers après 3 mois (signal isolé, non reproduit) |
| **Glycémie et insulino-résistance** | Légère amélioration possible | 🟠 **D** | Baisse modeste de la glycémie à jeun dans un petit essai |
| **SHBG (protéine liant les hormones sexuelles)** | Données masculines : baisse de la SHBG | 🔴 **E** | Potentiellement défavorable au SOPK si transposé chez la femme car augmenterait potentiellement la quantité de testostérone libre active, à confirmer |
...
|----------|:----:|-------------|
| **Efficacité** |    | HBP : effet probable/modéré (C). Glycémie et allergies : effet faible (D). Aucun effet hormonal démontré (E). |
| **Sécurité** | 🟢 **B** | Bonne tolérance générale. Données limitées chez la femme enceinte. |
| **Qualité** | 🟡 **C** | Grande variabilité des extraits ; choisir produits conformes à la Pharmacopée et mentionnant DER/solvant. |
