---
title: Gingembre
image: /img/principes/gingembre.jpg
categories: ["Plantes"]
synopsis: "Plante médicinale traditionnelle, preuves solides pour les nausées de grossesse et données modérées pour les nausées postopératoires ; efficacité limitée et contradictoire dans le mal des transports ; tolérance globalement bonne."
synonyms: ["Zingiber officinale", "Rhizome de gingembre"]
popular: false
slug: /principes/gingembre
hide_title: true
---
<div className="product-hero">
  <div className="product-hero__titlewrap">
    <h1 style={{margin:0}}>Gingembre</h1>
    <p style={{margin:0}}>
      <strong>**Nom scientifique** :</strong> *Zingiber officinale* Roscoe<br/>
      <strong>**Partie utilisée** :</strong> Rhizome (poudre, extrait sec)<br/>
      <strong>**Origine** :</strong> Asie du Sud/Sud-Est ; usage culinaire et médicinal mondial
    </p>
  </div>

<div className="product-hero__packshot">
    <img src="/img/principes/gingembre.jpg" alt="Gingembre" loading="eager" />
  </div>
</div>
