...
categories: ["Plantes"]
synopsis: "Racine médicinale utilisée traditionnellement comme adoucissante et digestive. Les extraits déglycyrrhizinés (DGL) montrent une efficacité probable sur la dyspepsie et la gorge irritée, avec une tolérance nettement supérieure à la racine brute riche en glycyrrhizine."
synonyms: ["Glycyrrhiza glabra", "Glycyrrhiza uralensis", "Liquiritiae radix"]
...
|-----------------|-------------------------------|:----------------:|------------------------|
| **Dyspepsie fonctionnelle / ulcère gastrique** | ↓ douleurs, brûlures et gêne postprandiale | 🟢 **B** | 75–150 mg/j d’extrait standardisé (*GutGard®*) sur 4 semaines. <br/>*Raveendra KR et al., 2012* |
| **Reflux gastro-œsophagien** | Amélioration des brûlures et régurgitations | 🟡 **C** | 150 mg/j, 4 semaines. <br/>*Al-Dujaili EA et al., 2025* |
| **Ulcères buccaux (aphte)** | Cicatrisation plus rapide, douleur réduite | 🟡 **C** | Patch oral 3 % extrait, 7 jours. <br/>*Martin MD et al., 2008* |
| **Sore throat postopératoire** | ↓ intensité et durée des symptômes | 🟢 **B** | Gargarismes à 0,5–1 % d’extrait aqueux. <br/>*Wang G et al., 2021* |
| **SOPK / métabolisme féminin** | Légère amélioration lipidique et IMC | 🟡 **C** | 300 mg/j, 8 semaines. <br/>*Hooshmandi H et al., 2024* |
| **Affections hépatiques** | ↓ modérée d’ALT/AST (hépatoprotecteur) | 🟡 **C** | 200–500 mg/j, 4–12 semaines. <br/>*Wu T et al., 2024* |
| **Paramètres hormonaux (testostérone, cortisol)** | ↑ cortisol et ↓ testostérone à forte dose | 🟠 **D** | > 400 mg glycyrrhizine/j. <br/>*Armanini D et al., 1999 ; Sigurjonsdottir HA et al., 2003* |
