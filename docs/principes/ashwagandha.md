...
Les données sur la **performance sportive**, autrefois prometteuses, sont désormais **contradictoires** (essais 2025), justifiant la prudence.
Les effets sur la **fonction sexuelle, la fertilité, la cognition et l’immunité** restent **exploratoires**, appuyés par des études de faible qualité ou non reproduites.
...
|---------------------------|-----------------------------------------|------------------|---------------|
| Stress / anxiété          | ↓ stress perçu, ↓ anxiété, ↓ cortisol (adultes stressés) | 🟡 C | 150–600 mg/j, 4–12 sem. |
...
| Force musculaire          | Gain de force (pratiquants entraînés) | 🟠 D | 600 mg/j, 8 sem. |
...
|------------|------|-------------|
| Efficacité |  | Plausible sur stress, petit effet sommeil. Autres effets exploratoires (D/E). Absence de preuves robustes. |
