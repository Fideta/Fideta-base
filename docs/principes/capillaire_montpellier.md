...
|-----------------|-------------------------------|:----------------:|---------------|
| **Voies respiratoires hautes** | Adoucissant/expectorant dans la toux et les irritations ORL | ⚫ **F** | Non établie |
| **Chute de cheveux / santé capillaire** | Prévention de la chute et stimulation de la pousse | 🔴 **E** | Une seule étude multi-ingrédients, qualité faible |
| **Appareil urinaire** | Adjuvant des cystites et lithiases (usage traditionnel) | ⚫ **F** | Non établie |
...
|----------|:----:|-------------|
| **Efficacité** |   | Une seule étude multi-ingrédients publiée dans une revue prédatrice, sans preuve spécifique pour la plante. |
| **Sécurité** | 🟡 **C** | Tolérance présumée correcte, données humaines limitées. |
| **Qualité** | 🟠 **D** | Produits non standardisés, absence de monographie européenne, qualité variable. |
