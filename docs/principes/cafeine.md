...
categories: ["Molécules"]
synopsis: "Stimulant central aux effets bien documentés : vigilance, analgésie adjuvante, performance sportive ; perte de poids modeste ; données limitées en topique (cellulite)."
synonyms: ["1,3,7-triméthylxanthine"]
popular: false
...
|---------------------|--------------------------------------------------------------|------------------|--------------|
| Vigilance / attention | ↑ éveil, temps de réaction amélioré, surtout en privation de sommeil | ✅ A | 75–200 mg en prise unique |
...
|-------------|------|-------------|
| Efficacité  |       | Effets solides sur vigilance, douleur adjuvante et endurance ; gain plus faible en force ; perte de poids modeste ; données limitées mais présentes en topique (cellulite). |
| Sécurité    | 🟢 B | Bien tolérée aux doses recommandées ; effets indésirables fréquents à haute dose ; interactions importantes via CYP1A2. |
| Qualité     | 🟢 B | Principe actif bien caractérisé, mais vigilance sur l’étiquetage et les mélanges stimulants. |
...
6. Haskell CF et al. (2005) – *Caffeine, cognition, and mood*. Psychopharmacology. → Amélioration vigilance et temps de réaction (n=30).  
7. Southward K. et al. (2018) – *Caffeine and endurance running performance*. Br J Sports Med. → Amélioration temps de course, 3–6 mg/kg.  
8. Hexsel D. et al. (2011) – *Topical caffeine gel in cellulite: RCT*. J Eur Acad Dermatol Venereol. → Réduction modeste du tour de cuisse après 6 semaines.  

---

### Essais cliniques négatifs / contradictoires
9. Tabrizi R. et al. (2019) – *Caffeine and weight loss: systematic review and meta-analysis*. Crit Rev Food Sci Nutr. → Effet modeste, hétérogène, pertinence clinique limitée.  
10. Drake C. et al. (2013) – *Caffeine effects on sleep*. J Clin Sleep Med. → Perturbation significative du sommeil même 6 h après ingestion (400 mg).  

---

### Interactions médicamenteuses (caféine)
11. Culm-Merdek KE et al. (2005) – *Fluvoxamine–caffeine interaction*. Br J Clin Pharmacol. → Inhibition forte du métabolisme de la caféine.  
