...
<div className="product-hero__packshot">
    <img src="/img/principes/melatonine.jpg" alt="Mélatonine" loading="eager" />
  </div>
</div>
---
...
|-----------------------------------|----------------------------------------------------------------------------------|------------------|--------------------------------------|
| Insomnie primaire (adultes)       | Réduction modeste de la latence d’endormissement (≈5 à 7 min)                  | ✅ A             | 0,5–2mg/jour ; optimal ≥2mg        |
| Troubles de l’alignement circadien| Réajustement du cycle veille–sommeil (jet lag, travail posté, phase retardée)   | ✅ A             | 0,5–2mg selon moment de prise        |
| Réveils nocturnes (WASO)          | Réduction de la durée ou fréquence des éveils nocturnes                         | ⚫ F             | Non établi                            |
| Autres effets (immunité, stress…) | Effets divers (antioxydant, immunité…)                                          | ⚫ F            | Non établi                            |
...
|-------------|--------|----------------------------------------------------------------------------|
| Efficacité  |   | Efficace sur latence et rythmes circadiens ; inefficace sur réveils nocturnes |
| Sécurité    | 🟢 B   | Bien tolérée à court terme ; données limitées sur le long terme             |
| Qualité     | 🟡 C   | Variabilité importante entre produits ; manque de contrôle en France        |
...
- ANSES (2018) – *Risques liés à la consommation de compléments alimentaires contenant de la mélatonine*, [anses.fr](https://www.anses.fr/fr/system/files/NUT2016SA0209EN.pdf)
