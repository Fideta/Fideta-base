...
image: /img/principes/Bifidobacterium-lactis.jpg
categories: ["Probiotiques"]
synopsis: "Espèce sûre, largement utilisée ; efficacité réelle mais très dépendante de la souche (BB-12, HN019, Bi-07). Données solides pour quelques indications ciblées (coliques du nourrisson, digestion du lactose), mais pas d’effet démontré pour les allégations larges type immunité ou confort digestif général."
synonyms: ["B. lactis", "Bifidobacterium animalis subsp. lactis"]
popular: false
slug: /principes/bifidobacterium-lactis
hide_title: true
---
...
<PrincipeHero
  title={"Bifidobacterium lactis"}
  scientificName={"Bifidobacterium animalis subsp. lactis"}
  partUsed={"micro-organisme vivant (lyophilisé)"}
  origin={"bactérie commensale du microbiote humain, également isolée de laits fermentés"}
  image={"/img/principes/Bifidobacterium-lactis.jpg"}
  imageAlt={"Bifidobacterium lactis"}
  path={"/docs/principes/bifidobacterium-lactis"}
/>
...
1. Araújo MM et al. *B. lactis & gastrointestinal symptoms – systematic review & meta-analysis*, Nutrition Reviews, 2022.  
2. Cheng J et al. *HN019 & constipation – RCT multicentrique*, JAMA Network Open, 2024.  
3. Nocerino R et al. *BB-12 in infant colic – RCT*, Aliment Pharmacol Ther, 2020.  
4. Chen K et al. *BB-12 & infant colic – RCT*, Beneficial Microbes, 2021.  
5. Taipale TJ et al. *BB-12 & infections in early childhood*, Pediatr Res, 2016.  
6. Turck D et al. (EFSA). *Bi-07 increases lactose digestion*, EFSA Journal, 2020.  
7. Jungersen M et al. *Science of BB-12*, Microorganisms, 2014.  
8. Merenstein D et al. *Safety of BB-12 in adults & children*, 2015.  
9. EFSA BIOHAZ Panel. *QPS list update – B. animalis*, EFSA Journal, 2022–2023.
