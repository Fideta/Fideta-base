...
|----------------------------|-----------------------------------------------------------------------------------------------|------------------|--------------------------------------|
| **Peau (esthétique)**      | Amélioration de l’hydratation, de l’élasticité, réduction des rides superficielles            | ✅ A              | 2,5 à 10g/j pendant 8–12 semaines    |
|                            | ⚠ *Rejet EFSA : ces effets esthétiques ne sont pas considérés comme une fonction cutanée (perméabilité, efficacité de la barrière cutanée)*     | ⚫ F              | –                                    |
| **Articulations**          | Réduction des douleurs, soutien du cartilage                                                 | 🟡 C              | Non établie                          |
| **Masse musculaire**       | Augmentation modeste de la masse maigre (avec entraînement)                                  | 🟡 C              | 5 à 15g/j + activité physique        |
...
|---------------|------|--------------------------------------------------------------|
| **Efficacité**|   | Effet établi sur la peau avec les formes hydrolysées         |
