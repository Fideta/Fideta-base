...
| Fatigue / humeur           | Amélioration générale                                 | ⚫ F              | Non démontré                  |
| Santé cognitive            | Prévention du déclin / Alzheimer                      | ⚫ F              | Données insuffisantes         |
| Absorption du magnésium    | Amélioration supposée de l’absorption                 | ⚫ F              | Non démontré chez l’humain|
...
|---------------|------|------------------------------------------------------------------------------|
| **Efficacité**|   | Forte utilité en cas de déficit, effet modeste ou incertain dans d'autres cas |
