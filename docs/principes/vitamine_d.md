...
Au-delà de ce seuil, les valeurs dites "optimales" restent discutées et ne justifient pas systématiquement une intervention.
Enfin, les **prises quotidiennes à dose modérée sont préférables aux bolus élevés (≥100 000 UI)**, qui sont associés à une moindre efficacité et à un risque accru de chutes chez les personnes âgées.
...
- **Effets secondaires :** hypercalcémie, fatigue, troubles digestifs, néphrocalcinose (en excès)  
- **Contre-indications :** hypercalcémie, hyperparathyroïdie, sarcoïdose, lithiase rénale  
- **Interactions :** diurétiques thiazidiques, digitaliques, calcium à forte dose, antiépileptiques  
- **Dose maximale recommandée :** 4000 UI/j (EFSA, NIH)  
  Bolus ≥100 000 UI : efficacité réduite, risque accru de chutes chez les personnes âgées

---

## 🧪 Forme et qualité du complément

- **Forme galénique :** gélules, gouttes, ampoules buvables  
- **Mode d'extraction :** D₃ : lanoline irradiée ou lichen ; D₂ : levures irradiées  
- **Certifications :** GMP, USP, VEGAN (D₃ végétale), BIO (huileuses spécifiques)
...
|-------------|------|------------------------------------------------------------------------------|
| Efficacité  |  | Très efficace pour l’os en cas de carence ; effet limité ou absent hors contexte |
| Sécurité    | 🟢 B   | Bien tolérée à dose physiologique ; risque de surdosage par automédication ou bolus |
| Qualité     | 🟢 B  | Formes huileuses mieux absorbées ; grande variabilité interproduits           |

---

## 📚 Références scientifiques

1. Martineau AR et al. (2017, 2021) – _Vitamin D supplementation to prevent acute respiratory tract infections_, BMJ.  
2. Sanders KM et al. (2010) – _High-dose vitamin D and risk of falls and fractures_, JAMA.  
3. Manson JE et al. (2019) – _Vitamin D and prevention of cancer and cardiovascular disease_, NEJM.  
4. EFSA (2012) – _Tolerable Upper Intake Level for Vitamin D_, EFSA Journal.  
5. VIDAL (2023) – _Le cas particulier de la vitamine D_, Pr J.-L. Schlienger, Université de Strasbourg.