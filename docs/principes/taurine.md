...
| **Longévité**                       | Vieillissement ralenti (animal)                                        | ⚫ F              | Études uniquement animales (Science, 2023), extrapolations non justifiées |
| **Absorption magnésium**            | Améliorerait l'absorption du magnésium (taurate de magnésium ou associé sous forme libre)| ⚫ F             | Aucune étude humaine ne permet de confirmer cela |
---
...
|---------------|------|--------------------------------------------------------------|
| **Efficacité**    |   | Les données sont fragmentées, parfois contradictoires ou non réplicables |
