...
La valeur de **40 µg/j** souvent affichée sur les compléments correspond uniquement à la **VNR (Valeur Nutritionnelle de Référence)** fixée par le règlement (UE) 1169/2011 pour l’étiquetage, et ne reflète pas un besoin physiologique démontré. 
...
1. Zhao F. et al. (2021) – _Chromium supplementation and T2D_, Biol Trace Elem Res.  
2. Asbaghi O. et al. (2020) – _Chromium in T2DM: meta-analysis_, Clin Nutr ESPEN.  
3. Costello RB. et al. (2016) – _Chromium supplements for glycemic control_, Nutr Rev.  
4. Tian H. et al. (2013) – _Chromium picolinate for overweight/obese adults_, Cochrane Review.  
