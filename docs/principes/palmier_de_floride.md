...
categories: ["Plantes"]
synopsis: "Fruit du palmier nain américain utilisé contre l’hypertrophie bénigne de la prostate (HBP). Les essais récents et revues Cochrane n’ont montré aucun bénéfice clinique significatif versus placebo. Tolérance excellente mais efficacité non démontrée ; SMR jugé modéré par la HAS pour raisons pragmatiques, non scientifiques."
synonyms: ["Saw Palmetto", "Sabal serrulata", "Serenoa serrulata", "Serenoa repens"]
...
|-----------------|-------------------------------|:----------------:|---------------|
| **Symptômes urinaires de l’HBP (IPSS/AUA-SI)** | Diminution des scores et amélioration de la qualité de vie (hommes) | ⚫ **F** | 320 à 960 mg/j d’extrait lipostérolique : aucun effet significatif vs placebo |
| **Débit urinaire / volume prostatique** | Amélioration du débit ou réduction du volume | ⚫ **F** | Pas de différence vs placebo |
| **Prostatite chronique / douleurs pelviennes** | Réduction des douleurs et symptômes | 🔴 **E** | Données limitées et non concluantes |
| **Alopécie androgénétique (homme)** | Ralentir la chute de cheveux / repousse | 🔴 **E** | Petits essais oraux/topiques, puissance insuffisante |
| **SOPK (syndrome des ovaires polykystiques)** | Effet anti-androgène / régulation hormonale | 🔴 **E** | Aucune étude clinique directe ; extrapolation masculine non validée |
| **Association avec α-bloquant** | Effet additif sur les symptômes urinaires | 🔴 **E** | Résultats hétérogènes, pas de preuve robuste |
...
|----------|:----:|-------------|
| **Efficacité** |    | Absence d’efficacité démontrée pour l’HBP et autres indications. |
| **Sécurité** | 🟢 **B** | Tolérance excellente ; rares effets mineurs. |
| **Qualité** | 🟡 **C** | Variabilité importante entre extraits et fabricants. |
