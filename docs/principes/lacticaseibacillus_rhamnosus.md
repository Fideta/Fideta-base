...
> Les effets documentés concernent principalement des souches précisément identifiées, notamment **LGG ATCC 53103**.
> En pratique, l’effet d’un probiotique doit toujours être évalué **souche par souche**, et non seulement à partir du nom d’espèce *Lacticaseibacillus rhamnosus*.
