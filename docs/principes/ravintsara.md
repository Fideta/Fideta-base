...
|-----------------|-------------------------------------------|:------------------------:|------------------------|
| **Stress, anxiété légère** | Diminution transitoire de l’anxiété après inhalation courte | 🟠 **D — Preuve faible** (étude pré–post non contrôlée, n=43) | Inhalation d'une dilution 1 % pendant 5 minutes |
...
| **Rhume, grippe, bronchite** | Réduction durée / intensité | ⚫ **F — Absence de preuve clinique** (aucune RCT) | Non établi |
| **Herpès labial, zona** | Raccourcissement des poussées | ⚫ **F — Absence de preuve clinique** | Non établi |
| **“Immunité”, prévention infections virales (dont COVID-19)** | Renforcement des défenses immunitaires | ⚫ **F — Absence de preuve clinique** | Non établi |
...
|--------|:-----------:|-------------|
| **Efficacité globale** |     | Aucune RCT disponible. Deux petites études exploratoires seulement (stress, diffusion en réanimation). Pas de démonstration d’effet antiviral, immunitaire ou ORL. |
| **Sécurité** | 🟡 **C** | Large historique d’usage, effets indésirables généralement légers. Risques théoriques (convulsions, bronchospasme) justifiant prudence chez certaines populations. |
| **Qualité** | 🟡 **C** | Forte variabilité entre huiles (camphre, 1,8-cinéole). Importance du chémotype et du GC/MS. Risque de confusion avec d’autres camphriers ou ravensara. |
