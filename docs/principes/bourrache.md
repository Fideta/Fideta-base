...
categories: ["Plantes"]
synopsis: "Plante médicinale traditionnelle dont les usages revendiqués (eczéma, peau, articulation) ne sont pas confirmés cliniquement. Inefficacité démontrée en dermatologie. Risque toxicologique lié aux alcaloïdes pyrrolizidiniques (PA), dépendant de la qualité. Balance bénéfice/risque défavorable."
synonyms: ["Borago officinalis", "Bourrache officinale"]
popular: true
...
|-----------------|----------------------------|:--:|--------------|
| **Dermatologie** | Eczéma / dermatite atopique | ⚫ **F** | ~300–360 mg de GLA/j (inefficacité démontrée) |
| **Peau** | Peau sèche, barrière cutanée, anti-âge | 🟠 **D** | Doses variables, essais faibles |
| **Rhumatologie** | Polyarthrite rhumatoïde (adjuvant) | 🟡 **C** | 1,4–2,8 g de GLA/j (fortes doses) |
| **Articulations** | Douleurs non spécifiques / arthrose | 🔴 **E** | Données humaines insuffisantes |
| **Respiratoire / digestif** | Sudorifique, expectorant, gastrite | ⚫ **F** | Aucune étude clinique humaine |
| **Virologie cutanée** | Herpès | ⚫ **F** | Absence totale de données humaines |
...
|--------|:--:|-------------|
| **Efficacité** |   | Aucun bénéfice clinique robuste démontré ; absence d'efficacité observée en dermatologie |
| **Sécurité** | ☠️ | Risque toxicologique réel lié aux PA, dépendant de la qualité |
| **Qualité** | 🟡 **C** | Variabilité importante entre fabricants ; contrôles PA indispensables |
