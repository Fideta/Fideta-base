...
categories: ["Plantes"]
synopsis: "Plante nord-américaine (surtout Echinacea purpurea) promue pour l’immunité. Les données humaines montrent au mieux un petit effet préventif, spécifique à certaines préparations standardisées ; pas de bénéfice clair pour traiter un rhume déclaré. Chez l’enfant, signal de baisse des antibiotiques avec des comprimés précis. Usage court (≤10 jours), non recommandé <12 ans. Tolérance globalement bonne à court terme."
synonyms: ["Echinacea", "Échinacée pourpre", "Echinacea purpurea", "Purple coneflower"]
