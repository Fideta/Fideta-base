---
title: Astragale
image: /img/principes/astragale.jpg
categories: ["Plantes"]
synopsis: "Indication solide en néphropathie diabétique (CKD), preuves modérées en IC/oncologie/douleur genou, faibles en diabète, inexistantes en immunité générale. Sécurité globalement bonne mais interactions importantes."
synonyms: ["Astragalus membranaceus", "Radix Astragali", "Huang Qi"]
popular: false
...
<PrincipeHero
  ...
  partUsed="sommités fleuries / parties aériennes"
  origin=" Chine, Mongolie (plante majeure en Médecine Traditionnelle Chinoise — MTC)"
  image="/img/principes/astragale.jpg"
  imageAlt="Astragale"
  path="/docs/principes/astragale"
/>
...
1. Chan KW et al. **Add-on Astragalus in Type 2 Diabetes and Chronic Kidney Disease** (48-week RCT). *Phytomedicine*.  
2. Han X et al. **Effect of Astragalus Injection on Left Ventricular Remodeling in Heart Failure** (meta-analysis). *Front Cardiovasc Med*.  
3. Lippi L et al. **Astragalus extract reduces functional knee pain** (Randomized, double-blind trial). *Front Pain Res*.  
4. Sheng X et al. **Astragalus for cancer-related fatigue** (meta-analysis). *Integr Cancer Ther*.  
5. Meta-analysis DT2 : Astragalus + metformine. *J Ethnopharmacol*.  
