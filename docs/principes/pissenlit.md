...
categories: ["Plantes", "Digestion", "Détox"]
synopsis: "Plante médicinale traditionnelle largement utilisée pour le drainage, la digestion et le foie, mais dont les effets ne sont pas confirmés par des données cliniques humaines robustes. Un signal très limité existe sur la diurèse avec la feuille, insuffisant pour soutenir un bénéfice réel."
synonyms: ["Taraxacum officinale", "Dandelion", "Dent-de-lion"]
popular: false
...
2. European Medicines Agency (EMA). **Assessment report on Taraxacum officinale F.H. Wigg., radix.** EMA/HMPC/475725/2020  
3. European Medicines Agency (EMA). **Assessment report on Taraxacum officinale Weber ex Wigg., radix cum herba.** EMA/HMPC/212897/2008  
4. European Medicines Agency (EMA). **Community herbal monograph on Taraxacum officinale Weber ex Wigg., folium.** EMA/HMPC/579636/2008  
5. National Center for Complementary and Integrative Health (NCCIH). **Dandelion.** NIH  
6. Sweeney B, Vora M, Ulbricht C, Basch E. **Evidence-based systematic review of dandelion (Taraxacum officinale).** *J Herb Pharmacother.* 2005  
7. Sannia A. **Phytotherapy with a mixture of dry extracts with hepato-protective effects in functional dyspepsia.** *Minerva Gastroenterol Dietol.* 2010 (multi-ingrédients)
