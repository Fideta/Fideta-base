...
categories: ["Minéraux"]
synopsis: "Nutriment essentiel, bénéfice démontré pour la prévention de la pré-éclampsie ; effets modestes sur densité osseuse, tension artérielle et syndrome prémenstruel ; pas d’efficacité en prévention primaire des fractures ni sur l’énergie."
synonyms: ["Ca²⁺"]
popular: false
...
|-------------|------|-------------|
| Efficacité  |      | Preuve solide pour la prééclampsie, bénéfices modestes sur la densité osseuse, la tension artérielle et le syndrome prémenstruel, absence d’effet démontré sur les fractures, l’énergie et le poids. |
| Sécurité    | 🟡 B | Globalement sûre aux doses usuelles, mais vigilance lithiases, interactions, hypercalcémie et contamination. |
| Qualité     | 🟢 A | Dépend fortement du sel choisi et des garanties de pureté, préférence pour les sels purifiés et certifiés. |
